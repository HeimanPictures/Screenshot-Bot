        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('🔖  Projects Channel', url='https://t.me/heimansupports')
                ],
                [
                    InlineKeyboardButton('💡  Higher Authority', url='http://t.me/HeimanTGSupport'),
                    InlineKeyboardButton('👨  Master', url='https://t.me/HeimanTGScreenshot_bot')
                ]
            ]
        )
    )
